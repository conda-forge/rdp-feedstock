...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rdp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12318&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rdp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rdp` can be installed with:

```
conda install rdp
```

It is possible to list all of the versions of `rdp` available on your platform with:
